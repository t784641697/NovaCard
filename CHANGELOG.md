...
### v1.0.99.79 (2026-06-28)
- 管理员用户管理: 6按钮全部显示(查看消费/充值/扣款/冻结/解冻/解锁)+按状态置灰
- 补后端 PATCH /api/admin/users/:id/status 接口(冻结/解冻)

## v1.0.99.78 (2026-06-28)
- 管理员用户管理: 解锁按钮始终显示(独立于冻结/解冻)

## v1.0.99.77 (2026-06-28)
- 管理员用户管理日期筛选改UTC+8时区修正(created_at存UTC但前端显示北京时间)

## v1.0.99.76 (2026-06-28)
- 管理员用户管理: 新增解锁按钮(locked用户可手动解锁)+后端 POST /api/admin/users/:id/unlock
- 修复unlock API中间件变量名auth→authenticate导致502

## v1.0.99.75 (2026-06-28)
- 管理员用户管理筛选项布局优化(等间距gap:12px 16px+弹性宽度+自动换行)

## v1.0.99.74 (2026-06-28)
- 管理员用户管理: 移除"已锁定"下拉选项(locked是系统自动状态)+搜索按钮右对齐防位移

## v1.0.99.73 (2026-06-28)
- 管理员用户管理: 日期placeholder改为"开始日期 - 结束日期"+min-width防位移

## v1.0.99.72 (2026-06-28)
- 管理员用户管理筛选区独立div+搜索框(cm-search-input-wrap)+DateRangePicker+状态下拉

## v1.0.99.71 (2026-06-28)
- 管理员用户管理: 移除标题+新增筛选(搜索/状态/日期)+后端支持keyword/dateFrom/dateTo/status

## v1.0.99.70 (2026-06-28)
- 卡片管理导出按钮改渐变色样式(cm-btn-search)+文字改"📥 导出 CSV"
